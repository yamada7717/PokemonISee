...
https://github.com/user-attachments/assets/be634f3a-9c67-49a6-bff6-ef062cd97049


### 検索機能
#### 検索機能の工夫点
- **記事の検索**:  ユーザーが既存サイトで抱えていた問題でもある、検索する際に「ポケモン名・トレーナー名を同時に検索ができない」といった問題点を解決しました。この検索機能ではユーザー名、ポケモン名、順位、持ち物、シーズンの中から好きな条件で同時に検索できます。


https://github.com/user-attachments/assets/fb58c2cf-a6a8-4b36-a85a-d6c3cdc2118a


### 記事の公開・非公開
#### 記事の公開・非公開の工夫点
- **公開・非公開**:  ユーザーが欲しい機能としてあった、記事の公開・非公開の切り替え機能。ポケモンパーティの記事は長文になることが多く役割の説明などを整理するため一時的に非公開にしたいというユーザーの声がありました。そこでバトルごと公開中と非公開中の記事を分けることによってその問題を解決しました。

https://github.com/user-attachments/assets/6d745c1e-2ac0-452a-92de-e406fc34d441
...
私は、ポケモン構築記事を読む友人の声をきっかけに、ユーザーフレンドリーな構築記事サイトを作りたいと思い、このアプリを開発しました。友人にヒアリングを行った結果、既存のサイトに以下の問題点があることがわかりました。

既存サイトの問題点
 - 検索機能が不十分: プレイヤー名やポケモン名、持ち物を同時に検索できない。
 - プライバシー設定が不便: 記事を公開・非公開に切り替えられない。

これらの問題に対応するため、ポケモン名や持ち物の同時検索機能、記事の公開・非公開機能、PokeAPIを使ったパーティ画像表示機能を実装し、ユーザーにとって使いやすい環境を提供しました。
このプロジェクトを通して、ユーザー視点での要件定義やフィードバックを反映させた機能改善の重要性を学び、今後もよりユーザーの声を大切にしている良いサービスを提供できるエンジニアを目指しています。
