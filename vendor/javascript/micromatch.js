import*as t from"util";import*as e from"braces";import*as r from"picomatch";import*as n from"picomatch/lib/utils";var a=t;try{"default"in t&&(a=t.default)}catch(t){}var o=e;try{"default"in e&&(o=e.default)}catch(t){}var l=r;try{"default"in r&&(l=r.default)}catch(t){}var s=n;try{"default"in n&&(s=n.default)}catch(t){}var c={};const i=a;const u=o;const f=l;const p=s;const isEmptyString=t=>t===""||t==="./"
/**
 ...
 * @summary false
 * @api public
 */;const micromatch=(t,e,r)=>{e=[].concat(e);t=[].concat(t);let n=new Set;let a=new Set;let o=new Set;let l=0;let onResult=t=>{o.add(t.output);r&&r.onResult&&r.onResult(t)};for(let o=0;o<e.length;o++){let s=f(String(e[o]),{...r,onResult:onResult},true);let c=s.state.negated||s.state.negatedExtglob;c&&l++;for(let e of t){let t=s(e,true);let r=c?!t.isMatch:t.isMatch;if(r)if(c)n.add(t.output);else{n.delete(t.output);a.add(t.output)}}}let s=l===e.length?[...o]:[...a];let c=s.filter((t=>!n.has(t)));if(r&&c.length===0){if(r.failglob===true)throw new Error(`No matches found for "${e.join(", ")}"`);if(r.nonull===true||r.nullglob===true)return r.unescape?e.map((t=>t.replace(/\\/g,""))):e}return c};micromatch.match=micromatch;
/**
 ...
 * @return {Array}
 * @api public
 */micromatch.braces=(t,e)=>{if(typeof t!=="string")throw new TypeError("Expected a string");return e&&e.nobrace===true||!/\{.*\}/.test(t)?[t]:u(t,e)};micromatch.braceExpand=(t,e)=>{if(typeof t!=="string")throw new TypeError("Expected a string");return micromatch.braces(t,{...e,expand:true})};c=micromatch;var d=c;export{d as default};
